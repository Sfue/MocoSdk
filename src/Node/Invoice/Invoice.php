...
class Invoice extends AbstractNodeObject
{
    ...
    protected $objectMapping = [
        ...
        'created_on' => '\DateTime',
        'updated_on' => '\DateTime',
        'items' => '\Sfue\MocoSdk\Node\Invoice\Data\Item',
        'payments' => '\Sfue\MocoSdk\Node\Invoice\Data\Invoice\Payment',
        'remindes' => '\Sfue\MocoSdk\Node\Invoice\Data\Invoice\Reminder'
    ];
